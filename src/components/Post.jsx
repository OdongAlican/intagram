  ...
  <div className="single-post-section">
    <div className="top-username-image-section">
      ...
      <div className="top-username-svg-section">
        <div className="top-username-section">{ post.username }</div>
    ...
    <div className="lower-svg-section">
      ...
      <div className="main-post-text-section">
        <h6>
          ...
          {' '}
          <span>
            { post.postText < 100 ? `${post.postText}`
              : `${post.postText.substring(0, 101)}...` }
          </span>
        </h6>
      </div>
      ...
      <div className="commentors-and-comments-sections">
        {
          post.commentors.slice(0, 2).map(commentor => (
            <h6 key={commentor.person}>
              {commentor.person}
              {' '}
              <span>
                {commentor.quotes}
